    ...
    <el-container style="height: 900px; border: 1px solid #eee">
      ...
      <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
        <el-menu :default-openeds="['1','2']"  router= "router"    :default-active="$route.path">
          ...
          <el-menu-item :index="courselist_student">我教的课</el-menu-item>
          <el-menu-item :index="courselisted_student">选课同学</el-menu-item>
          <el-menu-item :index="msg1">所有课程</el-menu-item>
...
export default {
  created(){
    ...
    this.msgid = "/Index_cort/crotea?id="+this.id
    this.msgupdata="/Index_cort/teaQryReadOnly?id="+this.id
    this.courselist_student="/Index_cort/corQryByTeaWritePartly?id="+this.id
    this.courselisted_student="/Index_cort/scrQryByCorT?id="+this.id
    // this.courselisted_student="/Index_grpt/scrQryByBanjiReadOnly?id="+this.id
    this.msg1="/Index_cort/corQryReadOnly?id="+this.id
    this.msg2="/Index_cort/LogMdf?id="+this.id
    this.msg3="/Index_cort/LogMdf?id="+this.id
